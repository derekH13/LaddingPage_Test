...
export const objPesquisaAtiva: propsPesquisaAtiva[] = [
  {
    ...
    texto:
      "Se você está hesitando em tomar decisões importantes para o futuro do seu negócio, o Pesquisa Ativa oferece insights baseados em dados reais do mercado.",
  },
  {
    icon: (
      <svg
